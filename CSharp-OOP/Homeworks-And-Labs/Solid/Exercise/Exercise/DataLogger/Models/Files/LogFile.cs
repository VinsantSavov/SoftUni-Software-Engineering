...
using DataLogger.Models.IOManagement;
using System;
using System.Globalization;
using System.IO;
using System.Linq;

namespace DataLogger.Models.Files
{
    public class LogFile : IFile
    {
        ...
        public string Write(ILayout layout, IError error)
        {
            ...
            string formattedMessage = String.Format(format, dateTime.ToString("M/dd/yyyy h:mm:ss tt", CultureInfo.InvariantCulture)
